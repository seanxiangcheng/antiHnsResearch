// In genany:
// Compile: gcc  -Wall  -lm -lgsl -lgslcblas -c  "%f"
// Build: gcc "%f" -Wall   -lm -lgsl -lgslcblas -o "%e" 
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <sys/types.h>
...
int main(int argc, char *argv[]){
  ...
  char energy_file[32] = "H6AF_E_k";	// Name of the output file of density of states
  char mag_file[32] = "H6AF_m_k";
  char energy_low_file[32] = "H6AF_E_low_k";
  char mag_low_file[32] = "H6AF_m_low_k";
  ...
  short sites[L];
  int neighbors[7*L+8], neighloc[L+1]; 	// store the neighbors index of all sites
