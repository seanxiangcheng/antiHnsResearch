...
void Initialize(short sites[], int neighbors[], int neighloc[], double temps[]){
  ...
  CurrentEnergy = (Intpow(2,K+2)-4)/2;
...
int main(int argc, char *argv[]){
  ...
  char energy_file[20] = "HPAF_E_";	// Name of the output file of density of states
  char mag_file[20] = "HPAF_m_";
  char energy_low_file[20] = "HPAF_E_low";
  char mag_low_file[20] = "HPAF_m_low";
  ...
  short sites[L];
  int neighbors[Intpow(2,K+2)-4], neighloc[L+1]; 	// store the neighbors index of all sites
